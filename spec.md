...
3. Do not execute any additional RPCs and instead log an event/message in order to facilitate garbage collection of unused resources at some later point in time.
