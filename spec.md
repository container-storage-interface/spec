...
message PluginCapability {
  ...
  message VolumeExpansion {
    enum Type {
      ...
      // EXPAND_VOLUME controller capability or both the EXPAND_VOLUME
      // controller capability and the EXPAND_VOLUME node
      // capability.
      //
