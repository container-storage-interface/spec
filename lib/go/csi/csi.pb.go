...
type CreateVolumeRequest struct {
	...
	CreateDeleteVolumeSecrets map[string]string `protobuf:"bytes,6,rep,name=create_delete_volume_secrets,json=createDeleteVolumeSecrets" json:"create_delete_volume_secrets,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *CreateVolumeRequest) GetCreateDeleteVolumeSecrets() map[string]string {
	if m != nil {
		return m.CreateDeleteVolumeSecrets
	}
	return nil
}
...
type DeleteVolumeRequest struct {
	...
	// logged, etc.) by the CO.
	// This field is OPTIONAL.
	CreateDeleteVolumeSecrets map[string]string `protobuf:"bytes,3,rep,name=create_delete_volume_secrets,json=createDeleteVolumeSecrets" json:"create_delete_volume_secrets,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *DeleteVolumeRequest) GetCreateDeleteVolumeSecrets() map[string]string {
	if m != nil {
		return m.CreateDeleteVolumeSecrets
	}
	return nil
...
type ControllerPublishVolumeRequest struct {
	...
	// logged, etc.) by the CO.
	// This field is OPTIONAL.
	VolumeSecrets map[string]string `protobuf:"bytes,6,rep,name=volume_secrets,json=volumeSecrets" json:"volume_secrets,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (m *ControllerPublishVolumeRequest) GetVolumeSecrets() map[string]string {
	if m != nil {
...
type ControllerUnpublishVolumeRequest struct {
	...
	// logged, etc.) by the CO.
	// This field is OPTIONAL.
	VolumeSecrets map[string]string `protobuf:"bytes,4,rep,name=volume_secrets,json=volumeSecrets" json:"volume_secrets,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *ControllerUnpublishVolumeRequest) GetVolumeSecrets() map[string]string {
	if m != nil {
		return m.VolumeSecrets
	}
	return nil
...
func (m *NodeStageVolumeRequest) GetVolumeSecrets() map[string]string {
	if m != nil {
		return m.VolumeSecrets
	}
	return nil
...
func (m *NodeUnstageVolumeRequest) GetVolumeSecrets() map[string]string {
	if m != nil {
		return m.VolumeSecrets
	}
	return nil
...
type NodePublishVolumeRequest struct {
	...
	// logged, etc.) by the CO.
	// This field is OPTIONAL.
	VolumeSecrets map[string]string `protobuf:"bytes,8,rep,name=volume_secrets,json=volumeSecrets" json:"volume_secrets,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	// logged, etc.) by the CO.
	// This field is OPTIONAL.
	WorkloadSecrets map[string]string `protobuf:"bytes,9,rep,name=workload_secrets,json=workloadSecrets" json:"workload_secrets,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Attributes of the volume to publish. This field is OPTIONAL and
	// MUST match the attributes of the Volume identified by
	// `volume_id`.
	VolumeAttributes map[string]string `protobuf:"bytes,10,rep,name=volume_attributes,json=volumeAttributes" json:"volume_attributes,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *NodePublishVolumeRequest) GetVolumeSecrets() map[string]string {
	if m != nil {
		return m.VolumeSecrets
	}
	return nil
...
func (m *NodePublishVolumeRequest) GetWorkloadSecrets() map[string]string {
	if m != nil {
		return m.WorkloadSecrets
	}
	return nil
}
...
type NodeUnpublishVolumeRequest struct {
	...
	// logged, etc.) by the CO.
	// This field is OPTIONAL.
	WorkloadSecrets map[string]string `protobuf:"bytes,5,rep,name=workload_secrets,json=workloadSecrets" json:"workload_secrets,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (m *NodeUnpublishVolumeRequest) GetVolumeSecrets() map[string]string {
	if m != nil {
		return m.VolumeSecrets
	}
	return nil
...
func (m *NodeUnpublishVolumeRequest) GetWorkloadSecrets() map[string]string {
	if m != nil {
		return m.WorkloadSecrets
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
