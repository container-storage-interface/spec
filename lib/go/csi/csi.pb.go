...
type Error_ProbeControllerError_ProbeControllerErrorCode int32
...
const (
	...
	// Recovery behavior: Caller SHOULD consider updating CSI client
	// to match Plugin CSI version.
	Error_ProbeControllerError_UNKNOWN                          Error_ProbeControllerError_ProbeControllerErrorCode = 0
	Error_ProbeControllerError_BAD_PLUGIN_CONFIG                Error_ProbeControllerError_ProbeControllerErrorCode = 1
	Error_ProbeControllerError_MISSING_REQUIRED_HOST_DEPENDENCY Error_ProbeControllerError_ProbeControllerErrorCode = 2
)

var Error_ProbeControllerError_ProbeControllerErrorCode_name = map[int32]string{
	0: "UNKNOWN",
	1: "BAD_PLUGIN_CONFIG",
	2: "MISSING_REQUIRED_HOST_DEPENDENCY",
}
var Error_ProbeControllerError_ProbeControllerErrorCode_value = map[string]int32{
	"UNKNOWN":                          0,
	"BAD_PLUGIN_CONFIG":                1,
	"MISSING_REQUIRED_HOST_DEPENDENCY": 2,
}

func (x Error_ProbeControllerError_ProbeControllerErrorCode) String() string {
	return proto.EnumName(Error_ProbeControllerError_ProbeControllerErrorCode_name, int32(x))
}
func (Error_ProbeControllerError_ProbeControllerErrorCode) EnumDescriptor() ([]byte, []int) {
...
func (m *ProbeControllerRequest) Reset()                    { *m = ProbeControllerRequest{} }
func (m *ProbeControllerRequest) String() string            { return proto.CompactTextString(m) }
func (*ProbeControllerRequest) ProtoMessage()               {}
func (*ProbeControllerRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }

func (m *ProbeControllerRequest) GetVersion() *Version {
	if m != nil {
		return m.Version
	}
	return nil
...
type ProbeControllerResponse struct {
	...
	//
	// Types that are valid to be assigned to Reply:
	//	*ProbeControllerResponse_Result_
	//	*ProbeControllerResponse_Error
	Reply isProbeControllerResponse_Reply `protobuf_oneof:"reply"`
}

func (m *ProbeControllerResponse) Reset()                    { *m = ProbeControllerResponse{} }
func (m *ProbeControllerResponse) String() string            { return proto.CompactTextString(m) }
func (*ProbeControllerResponse) ProtoMessage()               {}
func (*ProbeControllerResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{26} }

type isProbeControllerResponse_Reply interface {
	isProbeControllerResponse_Reply()
}

type ProbeControllerResponse_Result_ struct {
	Result *ProbeControllerResponse_Result `protobuf:"bytes,1,opt,name=result,oneof"`
}
type ProbeControllerResponse_Error struct {
	Error *Error `protobuf:"bytes,2,opt,name=error,oneof"`
}

func (*ProbeControllerResponse_Result_) isProbeControllerResponse_Reply() {}
func (*ProbeControllerResponse_Error) isProbeControllerResponse_Reply()   {}

func (m *ProbeControllerResponse) GetReply() isProbeControllerResponse_Reply {
	if m != nil {
		return m.Reply
	}
	return nil
...
func (m *ProbeControllerResponse) GetResult() *ProbeControllerResponse_Result {
	if x, ok := m.GetReply().(*ProbeControllerResponse_Result_); ok {
		return x.Result
	}
	return nil
}

func (m *ProbeControllerResponse) GetError() *Error {
	if x, ok := m.GetReply().(*ProbeControllerResponse_Error); ok {
		return x.Error
	}
	return nil
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*ProbeControllerResponse) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _ProbeControllerResponse_OneofMarshaler, _ProbeControllerResponse_OneofUnmarshaler, _ProbeControllerResponse_OneofSizer, []interface{}{
		(*ProbeControllerResponse_Result_)(nil),
		(*ProbeControllerResponse_Error)(nil),
	}
}

func _ProbeControllerResponse_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*ProbeControllerResponse)
	// reply
	switch x := m.Reply.(type) {
	case *ProbeControllerResponse_Result_:
		b.EncodeVarint(1<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Result); err != nil {
			return err
		}
	case *ProbeControllerResponse_Error:
		b.EncodeVarint(2<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.Error); err != nil {
			return err
		}
	case nil:
	default:
		return fmt.Errorf("ProbeControllerResponse.Reply has unexpected type %T", x)
	}
	return nil
}

func _ProbeControllerResponse_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*ProbeControllerResponse)
	switch tag {
	case 1: // reply.result
		if wire != proto.WireBytes {
		...
		msg := new(ProbeControllerResponse_Result)
		err := b.DecodeMessage(msg)
		m.Reply = &ProbeControllerResponse_Result_{msg}
		return true, err
	case 2: // reply.error
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		...
		msg := new(Error)
		err := b.DecodeMessage(msg)
		m.Reply = &ProbeControllerResponse_Error{msg}
		return true, err
	default:
		return false, nil
	}
...
func _ProbeControllerResponse_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*ProbeControllerResponse)
	// reply
	switch x := m.Reply.(type) {
	case *ProbeControllerResponse_Result_:
...
type ProbeControllerResponse_Result struct {
}

func (m *ProbeControllerResponse_Result) Reset()         { *m = ProbeControllerResponse_Result{} }
func (m *ProbeControllerResponse_Result) String() string { return proto.CompactTextString(m) }
func (*ProbeControllerResponse_Result) ProtoMessage()    {}
func (*ProbeControllerResponse_Result) Descriptor() ([]byte, []int) {
...
type Error_ProbeControllerError_ struct {
	ProbeControllerError *Error_ProbeControllerError `protobuf:"bytes,7,opt,name=probe_controller_error,json=probeControllerError,oneof"`
}
...
type Error_ProbeNodeError_ struct {
	ProbeNodeError *Error_ProbeNodeError `protobuf:"bytes,10,opt,name=probe_node_error,json=probeNodeError,oneof"`
}
...
func (*Error_ProbeControllerError_) isError_Value()            {}
...
func (m *Error) GetProbeControllerError() *Error_ProbeControllerError {
	if x, ok := m.GetValue().(*Error_ProbeControllerError_); ok {
		return x.ProbeControllerError
	}
	return nil
}
...
func (*Error) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _Error_OneofMarshaler, _Error_OneofUnmarshaler, _Error_OneofSizer, []interface{}{
		...
		(*Error_ProbeControllerError_)(nil),
...
func _Error_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *Error_ProbeControllerError_:
		b.EncodeVarint(7<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.ProbeControllerError); err != nil {
			return err
		}
...
func _Error_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 6: // value.validate_volume_capabilities_error
		...
		return true, err
	case 7: // value.probe_controller_error
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Error_ProbeControllerError)
		err := b.DecodeMessage(msg)
		m.Value = &Error_ProbeControllerError_{msg}
		return true, err
	...
	case 9: // value.node_unpublish_volume_error
		...
		return true, err
	case 10: // value.probe_node_error
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
...
func _Error_OneofSizer(msg proto.Message) (n int) {
	...
	case *Error_ValidateVolumeCapabilitiesError_:
		...
		n += s
	case *Error_ProbeControllerError_:
		s := proto.Size(x.ProbeControllerError)
...
type Error_ProbeControllerError struct {
	ErrorCode        Error_ProbeControllerError_ProbeControllerErrorCode `protobuf:"varint,1,opt,name=error_code,json=errorCode,enum=csi.Error_ProbeControllerError_ProbeControllerErrorCode" json:"error_code,omitempty"`
	ErrorDescription string                                              `protobuf:"bytes,2,opt,name=error_description,json=errorDescription" json:"error_description,omitempty"`
}

func (m *Error_ProbeControllerError) Reset()                    { *m = Error_ProbeControllerError{} }
func (m *Error_ProbeControllerError) String() string            { return proto.CompactTextString(m) }
func (*Error_ProbeControllerError) ProtoMessage()               {}
func (*Error_ProbeControllerError) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{41, 6} }

func (m *Error_ProbeControllerError) GetErrorCode() Error_ProbeControllerError_ProbeControllerErrorCode {
	if m != nil {
		return m.ErrorCode
	}
	return Error_ProbeControllerError_UNKNOWN
}

func (m *Error_ProbeControllerError) GetErrorDescription() string {
	if m != nil {
		return m.ErrorDescription
	}
	return ""
...
func (*Error_ProbeNodeError) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{41, 9} }
...
func init() {
	...
	proto.RegisterType((*ProbeControllerRequest)(nil), "csi.ProbeControllerRequest")
	proto.RegisterType((*ProbeControllerResponse)(nil), "csi.ProbeControllerResponse")
	proto.RegisterType((*ProbeControllerResponse_Result)(nil), "csi.ProbeControllerResponse.Result")
	...
	proto.RegisterType((*Error_ProbeControllerError)(nil), "csi.Error.ProbeControllerError")
	...
	proto.RegisterEnum("csi.Error_ProbeControllerError_ProbeControllerErrorCode", Error_ProbeControllerError_ProbeControllerErrorCode_name, Error_ProbeControllerError_ProbeControllerErrorCode_value)
...
func (c *controllerClient) ProbeController(ctx context.Context, in *ProbeControllerRequest, opts ...grpc.CallOption) (*ProbeControllerResponse, error) {
	out := new(ProbeControllerResponse)
	err := grpc.Invoke(ctx, "/csi.Controller/ProbeController", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Controller_ProbeController_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ProbeControllerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControllerServer).ProbeController(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/csi.Controller/ProbeController",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControllerServer).ProbeController(ctx, req.(*ProbeControllerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Controller_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Controller_ProbeController_Handler,
		},
		{
...
var fileDescriptor0 = []byte{
	...
	,
}
