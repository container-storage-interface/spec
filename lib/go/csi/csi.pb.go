...
type CreateVolumeResponse struct {
	...
	// This field is OPTIONAL.
	AlreadyExists *google_protobuf.BoolValue `protobuf:"bytes,2,opt,name=already_exists,json=alreadyExists" json:"already_exists,omitempty"`
}
...
func (m *CreateVolumeResponse) GetAlreadyExists() *google_protobuf.BoolValue {
	if m != nil {
...
type ControllerPublishVolumeResponse struct {
	...
	// This field is OPTIONAL.
	AlreadyPublished *google_protobuf.BoolValue `protobuf:"bytes,2,opt,name=already_published,json=alreadyPublished" json:"already_published,omitempty"`
}
...
func (m *ControllerPublishVolumeResponse) GetAlreadyPublished() *google_protobuf.BoolValue {
	if m != nil {
		return m.AlreadyPublished
	}
	return nil
}
...
type NodePublishVolumeResponse struct {
	...
	// state and no recovery actions are expected of a CO.
	// This field is OPTIONAL.
	AlreadyPublished *google_protobuf.BoolValue `protobuf:"bytes,1,opt,name=already_published,json=alreadyPublished" json:"already_published,omitempty"`
}
...
func (m *NodePublishVolumeResponse) GetAlreadyPublished() *google_protobuf.BoolValue {
	if m != nil {
		return m.AlreadyPublished
	}
	return nil
...
var fileDescriptor0 = []byte{
	...
	,
}
